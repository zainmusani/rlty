...
import styles from './AddBuyerDetailsStyles';

export default function AddBuyerDetailsView(props) {
  const {
    setValue,
    address,
    addressError,
        ...
        <>
          <View>
            ...
            <RadioBtnYesAndNo
              value={surveyToggle}
              setValue={boolean => {
                setToggle('surveyToggle', boolean);
                setToggle('newSurveyToggle', false);
              }}
            ...
            {/* Describe  your best  */}
            {/* <RadioBtnYesAndNo value={describeToggle} setValue={(boolean) => setToggle("describeToggle", boolean)} title="What describe you best?" /> */}
            ...
            {/*  Closing Date */}
            {/* <DatePicker error={closingDateError}
              title={'Closing Date'}
              isDate={true}
              date={closingDate}
              onDateChange={date => setValue({closingDate: date})}
            /> */}
            ...
            {/* CDA Sent to Title Company*/}
            {/* <RadioBtnYesAndNo value={CDAToggle} setValue={(boolean) => setToggle("CDAToggle", boolean)} title="CDA Sent to Title Company" /> */}
