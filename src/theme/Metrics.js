...
let statusBarHeightAndroid = StatusBar.currentHeight;

const NAVBAR_HEIGHT = Platform.OS === 'ios' ? 44 : 56;
const STATUSBAR_HEIGHT =
  Platform.OS === 'ios' ? (isIphoneX() ? 40 : 20) : statusBarHeightAndroid;
const LIST_BOTTOM_PADDING =
  Platform.OS === 'ios' ? (isIphoneX() ? 40 : 16) : 16;
const bottomNavbarHeight =
  Dimensions.get('screen').height - screenHeight + StatusBar.currentHeight;
...
export default {
  ...
  tabBarHeight: Platform.OS === 'android' ? 60 : 70, // Default tab bar height in iOS 10 (source react-navigation)
  borderRadius: 5,
  defaultUIHeight: ratio(48),
